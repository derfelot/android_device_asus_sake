...
$(call soong_config_set,surfaceflinger,udfps_lib,//$(LOCAL_PATH):libudfps_extension.sake)
...
$(call soong_config_set,lineage_health,charging_control_charging_path,/sys/class/asuslib/charging_suspend)
